---
name: companion
description: Orientation for the pagespace-cli harness. Use when working with PageSpace mounted under `pagespace/<drive>/…`. Explains that code lives in the local repo (edit + bash + tests as normal) while specs, plans, tasks, and knowledge live as PageSpace pages under the mount — read/write them like normal files.
---
