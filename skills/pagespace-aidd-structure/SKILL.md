...
Asynchronous data services, each in its own folder. Immutable data only. Adhere to [namespace](../pagespace-aidd-namespace/SKILL.md) guidelines.
...
Pure functional types and associated pure functions. Adhere to [namespace](../pagespace-aidd-namespace/SKILL.md) guidelines.
