---
name: pagespace-aidd-task-creator
...
Use /pagespace-aidd-functional-requirements to analyze and generate the requirements of the task.

## Agent Orchestration

For complex tasks that require specialized expertise, systematically employ the agent orchestrator pattern in /pagespace-aidd-agent-orchestrator
