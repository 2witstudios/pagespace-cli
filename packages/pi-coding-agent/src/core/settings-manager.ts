...
export interface Settings {
	...
	allowedProviders?: string[]; // Restrict model picker to these provider names (e.g. ["pagespace"])
...
export class SettingsManager {
	...
	getAllowedProviders(): string[] | undefined {
		return this.settings.allowedProviders;
	}
